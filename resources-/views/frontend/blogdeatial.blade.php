...
<section class="blog-page d-flex align-items-end">
    <div class="container text-white aos-init aos-animate" data-aos="fade-up">
        <h2 class="head-font fw-bold text-white">Blog details</h2>
...
<section id="recent-posts" class="recent-posts">
    <div class="container" data-aos="fade-up">
        ...
        <div class="text-start mb-5 d-flex justify-content-between ">
            <h2 class="fw-bold text-capitalize ">{{ $blog->title }}</h2>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="">
                    <article class="p-0 rounded-0 ">
                        ...
                        <div class="post-img rounded-0 m-0 ">
                            <img src="{{ $image }}" alt="" class="img-fluid rounded-0  w-100 ">
                        </div>
         ...
         <div class="row gy-4 my-3">
            <div class="text-start  d-flex justify-content-between ">
                <h2 class="fw-bold text-uppercase ">Related <span class="text-org">blog</span></h2>
            </div>
