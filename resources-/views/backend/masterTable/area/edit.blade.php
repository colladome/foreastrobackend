    ...
    <div class="col-lg-7 mx-auto">
        <div class="card">
            ...
            <div class="card-header">
                <h5 class="mb-0 h6">Edit Area</h5>
            </div>
            <form class="form-horizontal" action="{{ route('admin.masterTable.area.update', $area->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="name" name="name" value="{{ $area->name }}" class="form-control" autocomplete="off" required>
                                    @if($errors->has('name'))
