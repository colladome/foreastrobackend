...
<div class="row">
    <div class="col-lg-7 mx-auto">
        <div class="card">
            ...
            <form class="form-horizontal" action="{{ route('admin.masterTable.category.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="order" name="order" class="form-control" autocomplete="off" required>
                                    @if($errors->has('order'))
