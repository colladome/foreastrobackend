    ...
    <div class="col-lg-7 mx-auto">
        <div class="card">
            ...
            <div class="card-header">
                <h5 class="mb-0 h6">Update Photos</h5>
            </div>
            <form class="form-horizontal" action="{{ route('admin.updatePhoto', $photo->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="name" name="name" placeholder="Enter Name" value="{{ $photo->name }}" class="form-control" autocomplete="off" required>
                            @if($errors->has('name'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="place" name="place" value="{{ $photo->place }}" placeholder="Enter Place" class="form-control" autocomplete="off" required>
                            @if($errors->has('place'))
