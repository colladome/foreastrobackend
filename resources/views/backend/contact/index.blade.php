                    ...
                    <table id="contact" class="display" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="">{{ $contact->descreption}}</td>

                                <td>

                                    <a href="#" class="btn btn-danger deleteButton" id="deleteButton" data-item-id="{{ $contact->id }}"><i class="fa fa-trash" aria-hidden="true"></i>
...
<script>
    ...
    $('.deleteButton').click(function() {
        ...
        let route = "{{ route('admin.contact.destroy', 'PLACEHOLDER_ID') }}";
